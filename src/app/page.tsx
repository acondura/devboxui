        ...
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-slate-400 leading-relaxed max-w-xl mx-auto lg:mx-0">
              Instant DDEV & VS Code Remote SSH setup on your own infrastructure. High-performance, isolated development environments that work exactly like your local machine.
            </p>
