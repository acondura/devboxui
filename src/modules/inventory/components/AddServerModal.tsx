  ...
  const providers: {id: CloudProvider, name: string, active: boolean, info?: string}[] = [
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-sm animate-in fade-in duration-200">
        <div className="w-full max-w-md bg-white dark:bg-zinc-900 border border-red-200 rounded-2xl shadow-2xl overflow-hidden p-6 relative text-left">
          <div className="flex items-center space-x-3 text-red-500 mb-4">
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-100">Provisioning Failed</h3>
          </div>
          ...
          <div className="text-center">
            <button
              ...
              className="w-full bg-slate-100 dark:bg-zinc-700 hover:bg-slate-200 dark:hover:bg-zinc-600 text-slate-700 dark:text-zinc-200 font-bold py-3 rounded-xl transition-all text-sm border border-slate-205"
            >
              Dismiss
            </button>
          </div>
  ...
  if (bootstrapCommand) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-sm">
        <div className="w-full max-w-xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 rounded-2xl shadow-2xl overflow-hidden transform transition-all animate-in fade-in zoom-in duration-200 text-left">
          <div className="px-6 py-5 border-b border-slate-200 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-800/50 flex justify-between items-center">
             <div>
               <h3 className="text-xl font-bold text-slate-900 dark:text-zinc-100">Manual Setup Required</h3>
               <p className="text-xs text-indigo-600 dark:text-indigo-400 uppercase tracking-widest font-black mt-1">Provider: {provider}</p>
             </div>
             <button onClick={() => { setBootstrapCommand(null); onClose(); }} className="text-slate-400 dark:text-zinc-500 hover:text-slate-900 dark:hover:text-zinc-100 transition-colors">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="relative group">
              <div className="bg-slate-100 dark:bg-zinc-700 border border-slate-250 rounded-xl p-5 font-mono text-[10px] text-indigo-700 dark:text-indigo-300 break-all leading-relaxed shadow-inner max-h-[100px] overflow-y-auto">
                <span className="text-slate-500 dark:text-zinc-400 mr-2 select-none">$</span>
                {bootstrapCommand}
              </div>
              <button 
                onClick={() => {
                ...
                className="absolute top-3 right-3 p-2 bg-slate-205 hover:bg-slate-300 dark:hover:bg-zinc-600 text-slate-700 dark:text-zinc-200 rounded-lg transition-all shadow-lg"
            ...
            <div className="p-4 bg-slate-50 dark:bg-zinc-800/50 border border-slate-200/80 dark:border-zinc-700 rounded-xl">
              <h4 className="text-xs font-black uppercase tracking-widest text-slate-500 dark:text-zinc-400 mb-2">What happens next?</h4>
              <ul className="text-xs text-slate-600 dark:text-zinc-300 space-y-2 list-disc pl-4">
            ...
            <div className="text-center pt-2">
              <button
                ...
                className="w-full bg-slate-100 dark:bg-zinc-700 hover:bg-slate-200 dark:hover:bg-zinc-600 text-slate-700 dark:text-zinc-200 font-bold py-3.5 rounded-xl transition-all"
              >
  ...
  if (showSuccess) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-md">
        <div className="w-full max-w-md bg-white dark:bg-zinc-900 border border-indigo-200 rounded-3xl shadow-2xl overflow-hidden text-center p-8 relative">
          ...
          <div className="mt-8 space-y-4">
            <h3 className="text-2xl font-black text-slate-900 dark:text-zinc-100 italic">{bootstrapCommand ? 'READY TO LAUNCH! 🚀' : 'VICTORY! 🚀'}</h3>
            ...
            {bootstrapCommand && (
              <div className="bg-slate-50 dark:bg-zinc-800/50 border border-indigo-100 dark:border-indigo-800/50 rounded-2xl p-4 mt-6 text-left group relative overflow-hidden">
                <div className="absolute inset-0 bg-indigo-500/5 animate-pulse"></div>
                <p className="text-[10px] uppercase font-black text-indigo-600 dark:text-indigo-400 mb-2 tracking-widest flex items-center">
                  <span className="w-2 h-2 bg-indigo-600 dark:bg-indigo-400 rounded-full mr-2 animate-ping"></span>
                  Paste this on your server
                </p>
                <code className="text-xs text-slate-700 dark:text-zinc-200 font-mono break-all leading-relaxed block pr-8 max-h-[100px] overflow-y-auto scrollbar-thin">
                  {bootstrapCommand}
                </code>
                <button 
                  onClick={() => {
                  ...
                  className="absolute top-4 right-4 p-2 bg-slate-200 dark:bg-zinc-700 hover:bg-slate-300 dark:hover:bg-zinc-600 text-slate-700 dark:text-zinc-200 rounded-lg transition-all opacity-0 group-hover:opacity-100"
                  title="Copy to clipboard"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m-3 8h4m-2-2v4" />
            ...
            {!bootstrapCommand && (
              <div className="bg-slate-50 dark:bg-zinc-800/50 border border-slate-200 dark:border-zinc-700 rounded-2xl p-4 mt-6 text-left group">
                <p className="text-[10px] uppercase font-black text-slate-500 dark:text-zinc-400 mb-2 tracking-widest">Share your expert setup</p>
                <p className="text-xs text-indigo-600 dark:text-indigo-400 italic font-medium leading-relaxed">
            ...
            <div className="flex gap-3 pt-4">
              <button 
                ...
                className="flex-1 bg-slate-100 dark:bg-zinc-700 hover:bg-slate-200 dark:hover:bg-zinc-600 text-slate-700 dark:text-zinc-200 font-bold py-3 rounded-xl transition-all text-sm border border-slate-200 dark:border-zinc-600"
              >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-sm">
      <div className="w-full max-w-2xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 rounded-2xl shadow-2xl overflow-hidden transform transition-all animate-in fade-in zoom-in duration-200 text-left">
        ...
        <div className="px-6 py-4 bg-slate-50 dark:bg-zinc-800/50 border-b border-slate-205 dark:border-zinc-700">
          <label className="block text-xs font-bold text-slate-500 dark:text-zinc-400 uppercase tracking-wider mb-2.5">Select Cloud Provider</label>
          <Select2
            value={provider}
            onValueChange={(val) => {
            ...
            className="w-full bg-white dark:bg-zinc-900 border border-slate-300 dark:border-zinc-600 rounded-xl px-4 py-3 text-slate-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all text-sm font-medium"
          >
            {providers.map((p) => (
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-white dark:bg-zinc-900 border border-slate-300 dark:border-zinc-600 rounded-lg px-4 py-2.5 text-slate-900 dark:text-zinc-100 placeholder-slate-400 dark:placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-sm"
              />
            </div>

            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-zinc-200 mb-1.5">SSH Username (Optional)</label>
              <input
                type="text"
            ...
            {(provider === 'hetzner' || provider === 'digitalocean') && (
              <>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-zinc-200 mb-1.5">Server Type</label>
                  <Select2
                    value={serverType}
                    onValueChange={(val) => {
                      setServerType(val);
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-zinc-200 mb-1.5">Location</label>
                  <Select2
                    value={location}
                    onValueChange={(val) => {
                      setLocation(val);
                ...
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-zinc-200 mb-1.5">OS Image / Snapshot</label>
                  <Select2
                    value={image}
                    onValueChange={(val) => {
                      setImage(val);
          ...
          {!isLoadingOptions && currentType && (provider === 'hetzner' || provider === 'digitalocean') && (
            <div className="grid grid-cols-4 gap-2">
              ...
              <div className="bg-slate-50 dark:bg-zinc-800/50 border border-slate-200/80 dark:border-zinc-700 rounded-xl p-2.5 text-center group relative cursor-help">
                <p className="text-[11px] uppercase tracking-wider text-slate-500 dark:text-zinc-400 font-bold mb-0.5">RAM</p>
                <p className="text-sm font-bold text-slate-700 dark:text-zinc-200">{currentType.memory} GB</p>
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity bg-slate-900 text-slate-100 text-[10px] p-2 rounded shadow-xl w-36 pointer-events-none z-50">
                  Total system memory available.
                </div>
              </div>
              <div className="bg-slate-50 dark:bg-zinc-800/50 border border-slate-200/80 dark:border-zinc-700 rounded-xl p-2.5 text-center group relative cursor-help">
                <p className="text-[11px] uppercase tracking-wider text-slate-500 dark:text-zinc-400 font-bold mb-0.5">Disk</p>
                <p className="text-sm font-bold text-slate-700 dark:text-zinc-200">{currentType.disk} GB</p>
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity bg-slate-900 text-slate-100 text-[10px] p-2 rounded shadow-xl w-36 pointer-events-none z-50">
                  SSD-backed storage capacity.
                </div>
              </div>
              <div className="bg-slate-50 dark:bg-zinc-800/50 border border-slate-200/80 dark:border-zinc-700 rounded-xl p-2.5 text-center group relative cursor-help">
                <p className="text-[11px] uppercase tracking-wider text-slate-500 dark:text-zinc-400 font-bold mb-0.5">Arch</p>
                <p className="text-sm font-bold text-slate-700 dark:text-zinc-200 uppercase">{currentType.architecture}</p>
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity bg-slate-900 text-slate-100 text-[10px] p-2 rounded shadow-xl w-36 pointer-events-none z-50">
          ...
          {provider === 'contabo' && (
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-zinc-200 mb-1.5">Server IP Address</label>
                <input
                  type="text"
                  ...
                  required
                  className="w-full bg-white dark:bg-zinc-900 border border-slate-300 dark:border-zinc-600 rounded-lg px-4 py-2.5 text-slate-900 dark:text-zinc-100 placeholder-slate-400 dark:placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all text-sm"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-zinc-200 mb-1.5">Root Password</label>
                <input
                  type="password"
          ...
          {(provider === 'hetzner' || provider === 'digitalocean') && (
            <>
              <div className="bg-slate-50 dark:bg-zinc-800/50 border border-slate-200 dark:border-zinc-700 rounded-xl p-4 flex justify-between items-center group relative">
                <div>
                  <p className="text-xs uppercase tracking-wider text-slate-500 dark:text-zinc-400 font-bold">Cost</p>
                  <p className="text-2xl font-black text-slate-900 dark:text-zinc-100">
                    ...
                    <span className="text-sm text-slate-500 dark:text-zinc-400 font-normal ml-1">/ month</span>
                  </p>
                  {provider === 'hetzner' && (
                ...
                <div className="text-right">
                  <p className="text-xs uppercase tracking-wider text-slate-500 dark:text-zinc-400 font-bold">Billing Model</p>
          ...
          <div className="p-4 bg-indigo-55 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800/50 rounded-xl space-y-2.5">
            ...
            <p className="text-xs text-slate-650 dark:text-zinc-300 leading-relaxed">
              {provider === 'hetzner' || provider === 'digitalocean' ? (
                <>We&apos;ll create a clean <strong className="text-slate-800 dark:text-zinc-100 font-bold">{provider === 'hetzner' ? 'Hetzner' : 'DigitalOcean'}</strong> instance with your SSH key injected for instant connection.</>
              ) : (
                <>We&apos;ll connect to your <strong className="text-slate-800 dark:text-zinc-100 font-bold">existing server</strong>.</>
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full bg-indigo-600 hover:bg-indigo-500 disabled:bg-slate-100 dark:disabled:bg-zinc-700 disabled:text-slate-400 dark:disabled:text-zinc-500 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-indigo-500/20 flex items-center justify-center space-x-2"
            >
              {isSubmitting ? (
                <>
