  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-xl hover:border-indigo-500/50 transition-all group relative">
      ...
      <div className="p-5 space-y-5">
                    ...
                    <button
                      onClick={async (e) => {
                        ...
                        if (confirm(`Are you sure you want to delete the URL ${project.domain}?`)) {
                          ...
                          try {
                            await onDeleteDomain(server.id, project.domain);
                          } finally {
                      ...
                      className="p-1.5 text-slate-600 hover:text-rose-500 hover:bg-rose-500/10 rounded transition-colors disabled:opacity-50"
                      title="Delete URL"
                    >
        ...
        {(server.status === 'waiting-for-bootstrap' || showManualSetup) && (
