        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex space-x-3 pt-2">
            ...
            <button
              ...
              className="flex-[2] font-bold py-3.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl transition-all shadow-lg shadow-indigo-600/20 flex items-center justify-center"
            >
              Confirm & Shutdown
            </button>
          </div>
