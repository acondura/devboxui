...
namespace Drupal\bpmn_io\Plugin\modeler_api_modeler;
...
use Drupal\modeler_api\Plugin\modeler_api_modeler\ModelerBase;
...
class BpmnIo extends ModelerBase {
  ...
  public function configForm(ModelOwnerInterface $owner): AjaxResponse {
      ...
      if ($owner->ownerComponentEditable($plugin)) {
        if ($plugin instanceof ConfigurableInterface) {
          $this->prepareComponents()
            ->upcastConfiguration($config, $plugin->defaultConfiguration());
    ...
    foreach (Element::children($form) as $child) {
      if (isset($form[$child]['#type']) && $form[$child]['#type'] === 'entity_autocomplete') {
