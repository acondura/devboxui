...
use Drupal\modeler_api\Plugin\modeler_api_modeler\ModelerInterface;
...
class Api {
   ...
   *
   * @return \Drupal\modeler_api\Plugin\modeler_api_modeler\ModelerInterface|null
   ...
   *
   * @return \Drupal\modeler_api\Plugin\modeler_api_model_owner\ModelOwnerInterface|null
   *   The model owner
   */
   ...
   *
   * @param \Drupal\modeler_api\Plugin\modeler_api_model_owner\ModelOwnerInterface $owner
   *   The model owner.
   * @param \Drupal\Core\Config\Entity\ConfigEntityInterface $entity
